function convertToRoman(num) {
    ...
    for (let i in magArr) {
      ...
      for (let i in preRomArr) {
        ...
        else if (preRomArr[i].startsWith("C") && preRomArr[i].length > 3 && preRomArr[i].length < 5) {
          romArr.push("CD");} 
        
        else if (preRomArr[i].startsWith("C") && preRomArr[i].length > 5 && preRomArr[i].length < 9) {
        ...
        else if (preRomArr[i].startsWith("X") && preRomArr[i].length > 3 && preRomArr[i].length < 5) {
          romArr.push("XL");} 
    
        else if (preRomArr[i].startsWith("X") && preRomArr[i].length > 5 && preRomArr[i].length < 9) {
        ...
        else if (preRomArr[i].startsWith("I") && preRomArr[i].length > 3 && preRomArr[i].length < 5) {
        romArr.push("IV")}   
     
        else if (preRomArr[i].startsWith("I") && preRomArr[i].length > 5 && preRomArr[i].length < 9) {
