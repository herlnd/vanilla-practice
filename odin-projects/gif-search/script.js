...
const baseUrl =
  "https://api.giphy.com/v1/gifs/translate?api_key=RGSpqLTNeCUgFIBsO2kcC0KT2gf1R4rI&s=";
...
const changeOpacity = (selector, show) =>
  (document.querySelector(selector).style.opacity = show ? 1 : 0);
...
function getQuery(e) {
  ...
  fetch(fullUrl, { mode: "cors" })
    ...
    .catch(
      (err) => (document.querySelector(".loader h1").textContent = err.message)
    );
  //TODO
